...
name_fragment = r"""(?:(?:\p{Lu}\.)+|\p{Lu}+|(?:Jr|Rev|Sr|St)\.|da|de|der|la|van|von|[("]\p{Lu}\p{Ll}*(?:-\p{Lu}\p{Ll}*)*[)"]|(?:D'|d'|De|de|Des|Di|Du|L'|La|Le|Mac|Mc|O'|San|Van|Vander?|vanden)?\p{Lu}\p{Ll}+|97|Ch'ng|CôRhino|Di lorio|JiCi|JoAnne|MaryAnn|Prud'homme|ElSayeh|'T|NguyenTran)"""
