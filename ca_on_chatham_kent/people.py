    ...
    def scrape(self):
        ...
        for ward in wards:
            ...
            for councillor in councillors:
                ...
                image = page.xpath('//div[@id="ctl00_PlaceHolderMain_ctl03__ControlWrapper_RichHtmlField"]//img/@src')[
                    0
                ]
                ...
                address = page.xpath(
                    '//div[@id="div_contact_us_top_container_S"]//div[@class="div_contact_us_content_address"]'
                )[0].text_content()
                p.add_contact("address", address, "legislature")

                contacts = page.xpath(
                    '//div[@id="div_contact_us_top_container_S"]//div[@class="div_contact_us_content_kv"]/div'
                )
                voice_note_index = 0
